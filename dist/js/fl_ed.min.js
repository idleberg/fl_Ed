...
var debug=!0,default_x=100,default_y=100,default_w=800,default_h=600,default_input="",use_storage=function(){try{return"localStorage"in window&&null!==window.localStorage}catch(t){return!1}},set_defaults=function(){localStorage.setItem("editor.x",default_x),localStorage.setItem("editor.y",default_y),localStorage.setItem("editor.w",default_w),localStorage.setItem("editor.h",default_h),localStorage.setItem("editor.input",default_input),localStorage.setItem("editor.fullscreen",!1)},update_pos=function(t,e,o){e.text(t.width()+"✕"+t.height()+" — "+t.offset().left+"x "+t.offset().top+"y"),use_storage()&&(localStorage.setItem("editor.x",t.offset().left),localStorage.setItem("editor.y",t.offset().top),localStorage.setItem("editor.w",t.width()),localStorage.setItem("editor.h",t.height())),o&&debug&&console.info(o)};$.urlParam=function(t){var e=new RegExp("[\\?&]"+t+"=([^&#]*)").exec(window.location.href);return e?e[1]||0:void 0};
$(function(){$('[data-toggle="tooltip"]').tooltip(),console.log("fl_Ed | αlpha zero"),console.log("https://github.com/idleberg/fl_Ed"),console.log(""),$("#myTab a").click(function(e){e.preventDefault(),$(this).tab("show")});var e=$("#hover"),t=$("#footer"),o=$("#screen_info"),l=($(".navbar"),$(".arrow-up")),a=$(".credit"),i=$("#editor"),r=$(".editor-input");if(i.draggable({handle:".panel-heading",scroll:!1,containment:"window",drag:function(){update_pos(i,o,"Dragging…")}}),i.resizable({handles:"se",resize:function(){update_pos(i,o,"Resizing…")}}),e.mouseenter(function(){l.finish().fadeOut(200)}),e.mouseleave(function(){l.finish().fadeOut(200)}),l.delay(3e3).fadeOut(3e3),t.mouseenter(function(){a.finish().fadeIn(200)}),t.mouseleave(function(){a.finish().fadeOut(3e3)}),a.delay(3e3).fadeOut(3e3),r.keyup(function(){use_storage()&&(localStorage.setItem("editor.input",r.val()),debug&&console.info("Typing…"))}),$(".panel-heading").dblclick(function(){$(".panel").toggleClass("panel-fullscreen"),o.text(i.width()+"✕"+i.height()+" — "+i.offset().left+"x "+i.offset().top+"y"),$(".panel-fullscreen").is(":visible")?localStorage.setItem("editor.fullscreen",!0):localStorage.setItem("editor.fullscreen",!1),debug&&console.info("Toggle fullscreen")}),$(".toggle-fullscreen").click(function(){$(".panel").toggleClass("panel-fullscreen"),o.text(i.width()+"✕"+i.height()+" — "+i.offset().left+"x "+i.offset().top+"y"),$(".panel-fullscreen").is(":visible")?localStorage.setItem("editor.fullscreen",!0):localStorage.setItem("editor.fullscreen",!1),debug&&console.info("Toggle fullscreen")}),$(window).resize(function(){o.text(i.width()+"✕"+i.height()+" — "+i.offset().left+"x "+i.offset().top+"y")}),use_storage()){console.info("	localStorage is available!");var s=[];"true"==$.urlParam("reset")||"1"==$.urlParam("reset")?(console.info("Reset window.localStorage"),set_defaults(),window.location="index.html"):($.urlParam("editor.x")&&(s["editor.x"]=$.urlParam("editor.x"),localStorage.setItem("editor.x",s["editor.x"])),$.urlParam("editor.y")&&(s["editor.y"]=$.urlParam("editor.y"),localStorage.setItem("editor.y",s["editor.y"])),$.urlParam("editor.w")&&(s["editor.w"]=$.urlParam("editor.w"),localStorage.setItem("editor.w",s["editor.w"])),$.urlParam("editor.h")&&(s["editor.h"]=$.urlParam("editor.h"),localStorage.setItem("editor.h",s["editor.h"]))),0===localStorage.length&&set_defaults();for(var n=0;n<localStorage.length;n++){var d=localStorage.key(n),c=localStorage.getItem(d);s[d]=c,console.log("	"+d+"="+c)}i.css({position:"absolute",top:s["editor.y"]+"px",left:s["editor.x"]+"px",width:s["editor.w"]+"px",height:s["editor.h"]+"px"}).show(),"true"==s["editor.fullscreen"]?($(".panel").toggleClass("panel-fullscreen"),o.text(i.width()+"✕"+i.height()+" — "+i.offset().left+"x "+i.offset().top+"y")):o.text(s["editor.w"]+"✕"+s["editor.h"]+" — "+s["editor.x"]+"x "+s["editor.y"]+"y"),r.val(s["editor.input"])}else console.warn("no native support for HTML5 storage :("),o.text("Editor");i.hover(function(){i.css("z-index","0"),i.removeClass("panel-default").addClass("panel-muted"),$(this).css("z-index","1"),$(this).removeClass("panel-muted").addClass("panel-default")}),$(".export_data").click(function(){for(var e={},t=0;t<localStorage.length;t++){var o=localStorage.key(t),l=localStorage.getItem(o);e[o]=l}json=JSON.stringify(e,null," "),base64=window.btoa(json),hash=CryptoJS.SHA1(base64).toString().substring(0,7),file="fl_Ed-"+hash+".json",console.info("Exporting settings to "+file);var a=document.createElement("a");a.setAttribute("href","data:application/octet-stream;base64,"+base64),a.setAttribute("download",file),a.click()}),$(".close").click(function(){$(i).fadeOut("fast"),debug&&console.info("Hide editor")}),$(".lock-editor",".unlock-editor").click(function(){$(".lock-editor").is(":visible")?($(this).switchClass(".lock-editor",".unlock-editor").html('<i class="fa fa-fw fa-dot-circle-o"></i>'),$(i).resizable("disable").draggable("disable")):($(this).switchClass(".unlock-editor",".lock-editor").html('<i class="fa fa-fw fa-circle-o"></i>'),$(i).resizable("enable").draggable("enable"))}),$(".toggle-editor").click(function(){$(i).fadeToggle("fast"),debug&&console.info("Toggle editor")}),$(".close-menu").click(function(){$(".navmenu").offcanvas("hide")})});