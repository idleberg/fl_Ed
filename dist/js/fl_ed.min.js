...
var debug=!0,default_x=100,default_y=100,default_w=800,default_h=600,default_input="",default_checks=!1,use_storage=function(){try{return"localStorage"in window&&null!==window.localStorage}catch(e){return!1}},set_defaults=function(){localStorage.setItem("editor.x",default_x),localStorage.setItem("editor.y",default_y),localStorage.setItem("editor.w",default_w),localStorage.setItem("editor.h",default_h),localStorage.setItem("editor.input",default_input),localStorage.setItem("editor.fullscreen",!1),localStorage.setItem("editor.check1",default_checks),localStorage.setItem("editor.check2",default_checks)},update_pos=function(e,t,o){t.text(e.width()+"✕"+e.height()+" — "+e.offset().left+"x "+e.offset().top+"y"),use_storage()&&(localStorage.setItem("editor.x",e.offset().left),localStorage.setItem("editor.y",e.offset().top),localStorage.setItem("editor.w",e.width()),localStorage.setItem("editor.h",e.height())),o&&debug&&console.info(o)};$.urlParam=function(e){var t=new RegExp("[\\?&]"+e+"=([^&#]*)").exec(window.location.href);return t?t[1]||0:void 0};
$(function(){$('[data-toggle="tooltip"]').tooltip(),console.log("fl_Ed | αlpha zero"),console.log("https://github.com/idleberg/fl_Ed"),console.log(""),$("#myTab a").click(function(e){e.preventDefault(),$(this).tab("show")});var e=$("#hover"),t=$("#footer"),o=$("#screen_info"),l=($(".navbar"),$(".arrow-up")),i=$(".credit"),a=$('input[type="checkbox"]'),r=$("#editor"),n=$(".editor-input");if(r.draggable({handle:".panel-heading",scroll:!1,containment:"window",drag:function(){update_pos(r,o,"Dragging…")}}),r.resizable({handles:"se",resize:function(e,t){update_pos(r,o,"Resizing…")}}),e.mouseenter(function(){l.finish().fadeOut(200)}),e.mouseleave(function(){l.finish().fadeOut(200)}),l.delay(3e3).fadeOut(3e3),t.mouseenter(function(){i.finish().fadeIn(200)}),t.mouseleave(function(){i.finish().fadeOut(3e3)}),i.delay(3e3).fadeOut(3e3),n.keyup(function(){use_storage()&&(localStorage.setItem("editor.input",n.val()),debug&&console.info("Typing…"))}),a.click(function(){var e=$(this).attr("name");$(this).is(":checked")?(debug&&console.info("Checked "+e),localStorage.setItem("editor."+e,!0)):(debug&&console.info("Unchecked "+e),localStorage.setItem("editor."+e,!1))}),$(".panel-heading").dblclick(function(){$(".panel").toggleClass("panel-fullscreen"),o.text(r.width()+"✕"+r.height()+" — "+r.offset().left+"x "+r.offset().top+"y"),$(".panel-fullscreen").is(":visible")?localStorage.setItem("editor.fullscreen",!0):localStorage.setItem("editor.fullscreen",!1),debug&&console.info("Toggle fullscreen")}),$(".toggle-fullscreen").click(function(){$(".panel").toggleClass("panel-fullscreen"),o.text(r.width()+"✕"+r.height()+" — "+r.offset().left+"x "+r.offset().top+"y"),$(".panel-fullscreen").is(":visible")?localStorage.setItem("editor.fullscreen",!0):localStorage.setItem("editor.fullscreen",!1),debug&&console.info("Toggle fullscreen")}),$(window).resize(function(){o.text(r.width()+"✕"+r.height()+" — "+r.offset().left+"x "+r.offset().top+"y")}),use_storage()){console.info("	localStorage is available!");var s=[];"true"==$.urlParam("reset")||"1"==$.urlParam("reset")?(console.info("Reset window.localStorage"),set_defaults(),window.location="index.html"):($.urlParam("editor.x")&&(s["editor.x"]=$.urlParam("editor.x"),localStorage.setItem("editor.x",s["editor.x"])),$.urlParam("editor.y")&&(s["editor.y"]=$.urlParam("editor.y"),localStorage.setItem("editor.y",s["editor.y"])),$.urlParam("editor.w")&&(s["editor.w"]=$.urlParam("editor.w"),localStorage.setItem("editor.w",s["editor.w"])),$.urlParam("editor.h")&&(s["editor.h"]=$.urlParam("editor.h"),localStorage.setItem("editor.h",s["editor.h"]))),0===localStorage.length&&set_defaults();for(var c=0;c<localStorage.length;c++){var d=localStorage.key(c),f=localStorage.getItem(d);s[d]=f,console.log("	"+d+"="+f)}r.css({position:"absolute",top:s["editor.y"]+"px",left:s["editor.x"]+"px",width:s["editor.w"]+"px",height:s["editor.h"]+"px"}).show(),"true"==s["editor.fullscreen"]?($(".panel").toggleClass("panel-fullscreen"),o.text(r.width()+"✕"+r.height()+" — "+r.offset().left+"x "+r.offset().top+"y")):o.text(s["editor.w"]+"✕"+s["editor.h"]+" — "+s["editor.x"]+"x "+s["editor.y"]+"y"),n.val(s["editor.input"]),"true"==s["editor.check1"]&&$('input[name="check1"]').attr("checked","checked"),"true"==s["editor.check2"]&&$('input[name="check2"]').attr("checked","checked")}else console.warn("no native support for HTML5 storage :("),o.text("Editor");r.hover(function(){r.css("z-index","0"),r.removeClass("panel-default").addClass("panel-muted"),$(this).css("z-index","1"),$(this).removeClass("panel-muted").addClass("panel-default")}),$(".export_data").click(function(e){for(var t={},o=0;o<localStorage.length;o++){var l=localStorage.key(o),i=localStorage.getItem(l);t[l]=i}json=JSON.stringify(t,null," "),base64=window.btoa(json),hash=CryptoJS.SHA1(base64).toString().substring(0,7),file="fl_Ed-"+hash+".json",console.info("Exporting settings to "+file);var a=document.createElement("a");a.setAttribute("href","data:application/octet-stream;base64,"+base64),a.setAttribute("download",file),a.click()}),$(".close").click(function(e){$(r).fadeOut("fast"),debug&&console.info("Hide editor")}),$(".lock-editor",".unlock-editor").click(function(e){$(".lock-editor").is(":visible")?($(this).switchClass(".lock-editor",".unlock-editor").html('<i class="fa fa-fw fa-dot-circle-o"></i>'),$(r).resizable("disable").draggable("disable")):($(this).switchClass(".unlock-editor",".lock-editor").html('<i class="fa fa-fw fa-circle-o"></i>'),$(r).resizable("enable").draggable("enable"))}),$(".toggle-editor").click(function(e){$(r).fadeToggle("fast"),debug&&console.info("Toggle editor")}),$(".close-menu").click(function(e){$(".navmenu").offcanvas("hide")})});